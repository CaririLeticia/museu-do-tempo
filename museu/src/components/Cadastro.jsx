  ...
  return (
    <>
      <section className="flex">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col p-2">
            <div className="p-2 flex justify-center">
              <input
                ...
                required
                className="w-11/12 p-2 hover:border-gray-50 focus:border-amber-300 focus:ring-1 focus:ring-amber-200 outline-none rounded-2xl transition-all duration-300 ease-in-out"
                type="text"
                placeholder="Name"
              />
            </div>
        ...
        <div className="w-4/6">
          <img
            src="https://i0.wp.com/obarrete.com/wp-content/uploads/2020/11/the-death-of-socrates.png?w=1200&ssl=1"
